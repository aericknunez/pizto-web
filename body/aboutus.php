  <!-- ##### About Us Area Start ##### -->
    ...
    <!-- ##### About Us Area End ##### -->
     ...
     <!-- ##### About Us Area Start ##### -->
    <section class="about-us-area bg section-padding-0-0 clearfix" id="features">
        <div class="container-fluid">
            <div class="row align-items-center">
    ...
    <!-- ##### About Us Area Start ##### -->
    <section class="about-us-area section-padding-100-85 clearfix" >
        <div class="container">
            <div class="row align-items-center">
    ...
    <!-- ##### About Us Area End ##### -->
     ...
     <!-- ##### About Us Area Start ##### -->
    <!-- <section class="about-us-area section-padding-70-0">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-3 col-md-12 ">
                    ...
                    <div class="col-xs-12">
                        <div class="article special box-shadow">
                            <img src="img/features/3.png" class="i-icon" alt="">
                            <h3 class="article__title">Realtime Live Chat</h3> 
                            <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit. Tenetur quae dignissimos atque minima sit amet</p>               
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="article special box-shadow">
                            <img src="img/features/1.png" class="i-icon" alt="">
                            <h3 class="article__title"> Social Assistant</h3> 
                            <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit. Tenetur quae dignissimos atque minima sit amet</p>               
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-3 col-md-12">
                    ...
                    <div class="col-xs-12">
                        <div class="article special box-shadow mts-50">
                            <img src="img/features/2.png" class="i-icon" alt="">
                            <h3 class="article__title">Chart Modules</h3> 
                            <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit. Tenetur quae dignissimos atque minima sit amet</p>               
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="article special box-shadow">
                            <img src="img/features/4.png" class="i-icon" alt="">
                            <h3 class="article__title">AI Solutions</h3> 
                            <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit. Tenetur quae dignissimos atque minima sit amet</p>               
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6 offset-lg-0 col-md-10 offset-md-1">
                    <div class="who-we-contant">
                        ...
                        <h4 class="bl-text fadeInUp bold" data-wow-delay="0.3s">A Straight Forward Structare for Powerful Automation Results.</h4>
